...
import { BrainCircuit, Building, Mail, Lock, ArrowRight, ShieldCheck } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-[#FAFAFB] dark:bg-[#0F1117]">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <p className="mt-2 text-xs text-gray-500">
          Создание изолированного рабочего пространства (tenant_id)
        </p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md px-4">
        <div className="bg-white dark:bg-[#161922] py-8 px-6 shadow-xl rounded-2xl border border-gray-200 dark:border-gray-800 sm:px-10">
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider mb-1.5">
                Корпоративный Email администратора
              </label>
              <div className="relative">
            ...
            <div className="flex items-center gap-2 text-[11px] text-gray-500 py-1">
              ...
              <span>Создаётся изолированная векторная коллекция в Qdrant</span>
            </div>
            ...
            >
              {loading ? (
                ...
                <>
                  <span>Создать пространство компании</span>
          ...
          <div className="mt-6 pt-6 border-t border-gray-100 dark:border-gray-800 text-center text-xs text-gray-500">
            ...
            <Link href="/login" className="text-indigo-600 dark:text-indigo-400 font-semibold hover:underline">
              Войти в существующее пространство
            </Link>
          </div>
        </div>
      </div>
